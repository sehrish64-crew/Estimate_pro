...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Vehicle Health Estimate - ${tmap['banner_title'] || "Check any car's history"}`,
    keywords: ['car history', 'vehicle report', 'VIN check', 'used car', 'vehicle history check', 'car background check'],
    authors: [{ name: 'Vehicle Health Estimate' }],
    creator: 'Vehicle Health Estimate',
    icons: {
      icon: [
    ...
    openGraph: {
      type: 'website',
      url: 'https://Vehicle Health Estimate.com',
      title: `Vehicle Health Estimate - ${tmap['banner_title'] || "Check any car's history"}`,
      siteName: 'Vehicle Health Estimate',
      images: [
        { url: 'https://Vehicle Health Estimate.com/banner-hero.png', width: 1200, height: 630 },
      ],
    },
    twitter: {
      ...
      images: [
        { url: 'https://Vehicle Health Estimate.com/banner-hero.png' },
      ],
    },
  }
}
  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <link rel="canonical" href="https://Vehicle Health Estimate.com" />
