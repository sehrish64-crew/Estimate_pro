...
export const metadata: Metadata = {
  title: 'Health Check - Vehicle Health Estimate',
  robots: 'noindex',
};
...
export default function HealthPage() {
  return (
    <div style={{ padding: '40px', fontFamily: 'monospace', backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
      <h1>🏥 Vehicle Health Estimate Health Check</h1>
...
Database: Configured (check /api/test-db)`}
      ...
      <div style={{ marginTop: '20px', backgroundColor: '#fffacd', padding: '20px', borderRadius: '5px' }}>
        ...
        <ol>
          <li>Make sure <strong>robots.txt</strong> is accessible: https://Vehicle Health Estimate.com/robots.txt</li>
          <li>Check <strong>sitemap.xml</strong> is valid: https://Vehicle Health Estimate.com/sitemap.xml</li>
          <li>Ensure main page loads without errors: https://Vehicle Health Estimate.com/</li>
