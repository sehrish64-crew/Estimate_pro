      ...
      <div className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-20 text-center max-w-4xl relative">
          ...
          <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/5 text-green-400 font-semibold border border-white/10">
            <Shield size={16} /> About Vehicle Health Estimate
          </span>
          ...
          <p className="text-gray-400 mt-5 text-lg">
            Vehicle Health Estimate is a digital PDF report platform powered by billions of verified records from 900+ global databases. We provide instant access to comprehensive reports including ownership history, accident records, odometer readings, title information, damage assessment, and theft records.
          </p>
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-5">
            ...
            <h2 className="text-3xl md:text-5xl font-bold">
              Why We Built <span className="text-green-400">Vehicle Health Estimate</span>
            </h2>
            ...
            <p className="text-gray-400">
              Our platform gives you instant access to verified digital PDF reports so you can avoid scams and make confident decisions.
            </p>
