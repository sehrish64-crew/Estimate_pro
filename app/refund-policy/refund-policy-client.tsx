      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="mt-10 space-y-8 max-w-3xl mx-auto text-gray-100">
          ...
          <section>
            ...
            <p className="mt-3">These Terms and Conditions ("Agreement") form a legally binding contract between you ("Buyer", "you", or "your"), <strong>Paddle</strong> (as defined below), and <strong>Nexlify Labs LTD</strong> ("Supplier", "we", "our", or "us") and govern your use of the services provided via <strong>Vehicle Health Estimate.com</strong>.</p>
          ...
          <section>
            ...
            <ol className="mt-3 space-y-2 list-decimal list-inside">
              <li>You select a Product on Vehicle Health Estimate.com</li>
          ...
          <section>
            ...
            <div className="mt-6 ml-4">
              ...
              {/* <ul className="mt-2 space-y-2 list-disc list-inside">
                <li>Email: <a href="mailto:Info@vehiclehealthestimate.com" className="text-blue-600 hover:underline">Info@vehiclehealthestimate.com</a></li>
          ...
          <section>
            ...
            <p className="mt-3">All content, reports, branding, and systems on Vehicle Health Estimate.com are the intellectual property of <strong>Nexlify Labs LTD</strong> and may not be copied, resold, or redistributed.</p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 bg-blue-50 p-4 rounded-lg border border-blue-200 space-y-2">
              ...
              <p className="text-gray-700"><strong>Website:</strong> <a href="https://Vehicle Health Estimate.com" className="text-blue-600 hover:underline">https://Vehicle Health Estimate.com</a></p>
              <p className="text-gray-700"><strong>Support:</strong> <a href="mailto:Info@vehiclehealthestimate.com" className="text-blue-600 hover:underline">Info@vehiclehealthestimate.com</a></p>
