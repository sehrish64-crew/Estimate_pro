    ...
    <div className="bg-black min-h-screen">
      <div className="relative container mx-auto px-6 py-20">
        ...
        <div className="mt-10 space-y-8 max-w-3xl mx-auto text-gray-100">
          <section>
            <p className="text-lg font-semibold text-gray-100 mb-4">Nexlify Labs LTD, operating Vehicle Health Estimate.com, is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.</p>
          ...
          <section>
            ...
            <p className="mt-4">To exercise these rights, please contact us at Info@vehiclehealthestimate.com.</p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 bg-blue-50 p-4 rounded-lg border border-blue-200 space-y-2">
              ...
              <p className="text-gray-700"><strong>Email:</strong> <a href="mailto:Info@vehiclehealthestimate.com" className="text-blue-600 hover:underline">Info@vehiclehealthestimate.com</a></p>
