          ...
          <div className="relative grid lg:grid-cols-2 gap-10 p-6 md:p-12">
            ...
            <div className="text-white space-y-5 text-center lg:text-left">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-snug">
                Instantly access a digital PDF report before you buy
              </h2>

              <p className="text-white/80 text-sm md:text-base">
                Check accident history, mileage tampering, ownership changes and hidden issues in seconds with a digital PDF report.
              </p>
