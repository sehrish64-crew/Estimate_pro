...
const contactInfo = [
  {
    icon: Mail,
    title: 'Email',
    details: ['Info@vehiclehealthestimate.com'],
      ...
      <div ref={heroRef} className="relative container mx-auto px-4 py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold mt-6">
            Contact <span className="text-green-400">Vehicle Health Estimate</span>
          </h1>

          <p className="text-gray-400 mt-4 text-lg">
            We’re here to help you with digital PDF report support anytime.
          </p>
        </div>
